...
CREATE VIEW actoresConMasPeliculas as
...
CREATE VIEW peliculasDistintasPorLocal AS
...
--Como no hay nombre del local, poner en su lugar 
--la dirección incluyendo ciudad y país además de la cantidad
CREATE VIEW inventarioPorLocal AS
...
CREATE VIEW PeliculasDe1Horaa2Horas AS
